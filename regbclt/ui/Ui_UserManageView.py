...
# Form implementation generated from reading ui file 'D:\ChruchProjects\regbook\regbclt\ui\UserManageView.ui'
#
...
class Ui_UserManageView(object):
   def setupUi(self, UserManageView):
      ...
      self.searchname = QtWidgets.QLineEdit(UserManageView)
      self.searchname.setObjectName("searchname")
      self.horizontalLayout_2.addWidget(self.searchname)
      ...
      self.finnameLabel.setBuddy(self.searchname)
   ...
   def retranslateUi(self, UserManageView):
      ...
      self.finnameLabel.setText(_translate("UserManageView", "Search(&S)"))
...
if __name__ == "__main__":
   ...
   UserManageView = QtWidgets.QWidget()
   ui = Ui_UserManageView()
   ui.setupUi(UserManageView)
   UserManageView.show()
   sys.exit(app.exec_())
